...
class TlsInfo:
    ...
    def __init__(self, feature):
        ...
        self.func_dict = self._tls_packet_loop()

    # TODO: Add documentation to functions
    # Functions for getting information within various TLS fields
    def app_data(self):
        return self.func_dict .get('app_data')

    def alpn(self):
        return self.func_dict.get('alpn')

    def client_authz(self):
        return self.func_dict.get('client_authz')

    def client_cert_type(self):
        return self.func_dict.get('client_certificate_type')

    def client_cert_url(self):
        return self.func_dict.get('client_certificate_url')

    def client_cipher_suit(self):
        return self.func_dict.get('client_cipher_suit')

    def client_hello_msglen(self):
        return self.func_dict.get('client_hello_msglen')

    def cookie(self):
        return self.func_dict.get('cookie')

    def compression(self):
        return self.func_dict.get('compr')

    def csr(self):
        return self.func_dict.get('csr')

    def early_data(self):
        return self.func_dict.get('early_data')

    def encrypt_then_mac(self):
        return self.func_dict.get('encrypt_then_mac')

    def heartbeat(self):
        return self.func_dict.get('heartbeat')

    def keyshare(self):
        return self.func_dict.get('keyshare')

    def keyshare_ch(self):
        return self.func_dict.get('keyshare_ch')

    def keyshare_sh(self):
        return self.func_dict.get('keyshare_sh')

    def master_secret(self):
        return self.func_dict.get('master_secret')

    def max_frag(self):
        return self.func_dict.get('max_frag')

    def ocsp(self):
        return self.func_dict.get('ocsp')

    def padding(self):
        return self.func_dict.get('padding')

    def post_handshake_auth(self):
        return self.func_dict.get('post_handshake_auth')

    def pre_shared_key(self):
        return self.func_dict.get('pre_shared_key')

    def psk_key_exch(self):
        return self.func_dict.get('psk_key_exch')

    def record_size_limit(self):
        return self.func_dict.get('record_size_limit')
    ...
    def session_lifetime(self):
        return self.func_dict.get('lifetime')

    def signature_algorithm(self):
        return self.func_dict.get('signature_algorithms')

    def signature_algorithm_cert(self):
        return self.func_dict.get('signature_algorithms_cert')

    def sup_groups(self):
        return self.func_dict.get('supported_groups')

    def supported_elip(self):
        return self.func_dict.get('supported_elliptic')

    def supported_point_format(self):
        return self.func_dict.get('supported_point_format')

    def supported_version(self):
        return self.func_dict.get('supported_version')

    def supported_version_ch(self):
        return self.func_dict.get('supported_version_ch')

    def supported_version_sh(self):
        return self.func_dict.get('supported_version_sh')

    def ticket_early_data_info(self):
        return self.func_dict.get('early_data_ticket')

    def tls_alert(self):
        return self.func_dict.get('tls_alert')

    def truncated_hmac(self):
        return self.func_dict.get('truncated_hmac')

    def trusted_ca(self):
        return self.func_dict.get('trusted_ca')

    def user_mapping(self):
        return self.func_dict.get('user_mapping')
