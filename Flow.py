...
class Flow:
    ...
    def get_data(self) -> dict:
        ...
        return {
            ...
            'KeyShareSH'  : tls.keyshare_sh(),
            'MasterSecret' : tls.master_secret(),
            'MaxFrag' : tls.max_frag(),
            'OCSP' : tls.ocsp(),
            'Padding' : tls.padding(),
            'PostHandShakeAuthentication' : tls.post_handshake_auth(),
            'PreSharedKey' : tls.pre_shared_key(),
            'PskKeyExch' : tls.psk_key_exch(),
            'RecordSizeLimit' : tls.record_size_limit(),
            'Renegotiation' : tls.renogotiation(),
            'ServerCertificateType' : tls.server_cert_type(),
            'ServerAuthz' : tls.server_authz(),
            ...
            'SupportedSh' : tls.supported_version_sh(),
